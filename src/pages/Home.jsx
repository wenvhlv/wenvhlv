    ...
    <div className="home-container">
      ...
      <section className="section light">
        <div className="content left">
          ...
          <ul>
            <li>
              Software Engineer at <strong>Rakuten Group Inc. Tokyo, Japan</strong>.
            </li>
            <li>
              Email ID: <a href="mailto:hlvcse@gmail.com">hlvcse@gmail.com</a>
            </li>
            <li>
              GitHub: <a href="https://github.com/hlvcse">https://github.com/hlvcse</a>
            </li>
            <li>
              LinkedIn: <a href="https://linkedin.com/in/hlvcse">https://linkedin.com/in/hlvcse</a>
            </li>
            <li>
              Contact: +918287648766(Whatsapp Only), +817083110880(Call)
            </li>
          </ul>
        </div>
        <div className="image right">
          <img src={RakutenWork} alt="Description" className="image-style" />
        </div>
      </section>
      ...
      <section className="section blue">
        <div className="image right">
          <img src={IITImg} alt="Description" className="image-style2" />
        </div>
        <div className="content left">
          <h2>🎓 Educational Qualifications</h2>
          <ul>
            <li>
              <strong>M.Tech(CSE)</strong> from <strong>IIT Ropar</strong>, CGPA :
              7.38/10, Year:2021-23
            </li>
            <li>
              <strong>B.Tech(CSE)</strong> from <strong>NIT Manipur</strong>, CGPA :
      ...
      <section className="section light">
        <div className="content left">
          ...
          <ul>
            <li>
              <strong>Programming Languages:</strong> C, C++, Python, SQL
            </li>
            <li>
              <strong>Libraries & Frameworks:</strong> NumPy, Pandas, Matplotlib,
        ...
        <div className="image right">
          <img src={MySelf} alt="Description" className="image-myself" />
        </div>
      </section>
      ...
      <section className="section blue">
        <div className="image right">
          <img src={RakutenImg} alt="Description" className="image-style2" />
        </div>
        <div className="content left">
      ...
      <section className="section light">
        <div className="content left">
          ...
          <ul>
            <li>May–July 2018</li>
            <li>
              Built human classifiers using HOG features and SVM, implemented
              real-time detection system to detect human in any input image.
            </li>
            <li>
              Tools& Technologies: Python, OpenCV, Scikit-learn, Matplotlib,
              Machine Learning, Image Processing, Computer Vision.
            </li>
          </ul>
        </div>
        <div className="image right">
          <img src={InternImg} alt="Description" className="image-style3" />
        </div>
      </section>

      <h1 className="project-head">💻 Major Projects</h1>
      {/* Projects Section */}
      <section className="project-section">
        <div className="project-left">
          ...
          <ul>
            <li>
              Visit my website:{' '}
              <a href="https://www.iitjeemathx.com/">
                https://www.iitjeemathx.com/
              </a>
            </li>
            <li>
              <strong>Tools& Technologies: </strong>HTML, CSS, JavaScript,
              React.js, Firebase, EmailJS, Versel, Git& Github, namechip.
            </li>
            <li>
              <strong>Description: </strong>Designed and deplyed fully end to end
              website named "IITJEE MATHX" for helping aspirants preparing for
              iitjee(mains and advance) and similar comeptitive exams. Aspirants
              will get end-end video tutorials of best quality with PYQ Questions
              and free of cost. Deployed using versel and purchased domain from
              namechip for my professional website.
            </li>
          </ul>
        </div>
        ...
        <div className="project-right">
          ...
          <ul>
            <li>
              <strong>Tools& Technologies: </strong>HTML, CSS, JavaScript,
              React.js, Flask, Versel, Git& Github
            </li>
            <li>
              <strong>Description: </strong>Designed and deplyed fully end to edn
              my portfolio website to include my detailed information about my
              projects, interests, skills, projects and other details.
            </li>
          </ul>
        </div>
      </section>
      ...
      <footer className="footer">
        <div className="footer-content">
          <div className="footer-links">
            <a
              href="https://www.youtube.com/@iitjeemathx"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/hlvcse/"
              target="_blank"
              rel="noopener noreferrer"
            >
              LinkedIn
            ...
            <a
              href="https://www.instagram.com/_nvhlv/"
              target="_blank"
              rel="noopener noreferrer"
            >
              Instagram
            ...
            <a
              href="https://www.facebook.com/hanumatlal.vishwakarma.3"
              target="_blank"
              rel="noopener noreferrer"
            >
              Facebook
          ...
          <p className="footer-copy">
            © {new Date().getFullYear()} Portfolio - Hanumat Lal Vishwakarma. All
            rights reserved.
          </p>
        </div>
      </footer>
